#!/bin/bash
#
# Alphabet Kernel Build Script By @Siddhant Naik 
...
##############
ROOT_DIR=$(pwd)
KERNEL_NAME='Alpahbet-Kernel'
ARCHITECTURE=arm64
TOOLCHAIN=/home/ghaith/android/Toolchains/aarch64-cortex_a53-linux-gnueabi-gcc-6/bin/aarch64-cortex_a53-linux-gnueabi-
ANDROID=N
BUILD_DIR=$ROOT_DIR/alphabet
...
{
	DEVICE='A7_2017'
	DEFCONFIG=Alphabet_Kernel_a7y17lte_defconfig
...
{
	DEVICE='A5_2017'
	DEFCONFIG=Alphabet_Kernel_a5y17lte_defconfig
...
clean_junk()
{
	...
	rm -rf $ZIP_DIR/alphabetkernel/anykernel2/anykernel2.zip
}
